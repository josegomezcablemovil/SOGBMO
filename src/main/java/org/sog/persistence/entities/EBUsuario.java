...
public class EBUsuario implements Serializable {
    ...
    private int idsog_admon_usuarios;
    ...
    public int getIdsog_admon_usuarios() {
        return idsog_admon_usuarios;
    }

    public void setIdsog_admon_usuarios(int idsog_admon_usuarios) {
        this.idsog_admon_usuarios = idsog_admon_usuarios;
    }
